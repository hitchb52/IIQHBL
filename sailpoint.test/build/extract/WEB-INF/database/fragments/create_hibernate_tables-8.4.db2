...
-- 
    ...
    create table identityiq.spt_service_definition (
       id varchar(32) not null,
        ...
        iiqlock varchar(128),
        attributes clob(100000000),
        service_type varchar(255) default 'DEFAULT' not null,
        name_ci generated always as (upper(name)),
        primary key (id)
    ) IN identityiq_ts;
    ...
    create table identityiq.spt_task_result (
       id varchar(32) not null,
        ...
        sequential_monitor_id varchar(32),
        name_ci generated always as (upper(name)),
        target_name_ci generated always as (upper(target_name)),
...
-- 
-- IIQ schema create end
-- 


-- 
-- ACCESS HISTORY schema create begin
-- 
...
-- 
-- ACCESS HISTORY schema create end
-- 
